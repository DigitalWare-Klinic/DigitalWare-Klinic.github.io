...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>MedicationDispense.partOf.type</sch:title>
    <sch:rule context="f:MedicationDispense/f:partOf/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:medication[x] 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:medication[x]/f:coding 1</sch:title>
    <sch:rule context="f:MedicationDispense/f:medication[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:version) &lt;= 0">version: maximum cardinality of 'version' is 0</sch:assert>
      <sch:assert test="count(f:userSelected) &lt;= 0">userSelected: maximum cardinality of 'userSelected' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>MedicationDispense.destination.type</sch:title>
    <sch:rule context="f:MedicationDispense/f:destination/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
