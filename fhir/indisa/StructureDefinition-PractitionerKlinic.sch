...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>Practitioner.name.family.extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:qualification/f:identifier/f:type</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:qualification/f:identifier/f:type/f:coding</sch:title>
  ...
  <sch:pattern>
    <sch:title>Practitioner.qualification.identifier.type.coding.extension</sch:title>
    <sch:rule context="f:Practitioner/f:qualification/f:identifier/f:type/f:coding/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Practitioner.qualification.identifier.type.coding.system</sch:title>
    <sch:rule context="f:Practitioner/f:qualification/f:identifier/f:type/f:coding/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Practitioner.qualification.identifier.type.coding.version</sch:title>
    <sch:rule context="f:Practitioner/f:qualification/f:identifier/f:type/f:coding/f:version">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Practitioner.qualification.identifier.type.coding.code</sch:title>
    <sch:rule context="f:Practitioner/f:qualification/f:identifier/f:type/f:coding/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Practitioner.qualification.identifier.type.coding.display</sch:title>
    <sch:rule context="f:Practitioner/f:qualification/f:identifier/f:type/f:coding/f:display">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Practitioner.qualification.identifier.type.coding.userSelected</sch:title>
    <sch:rule context="f:Practitioner/f:qualification/f:identifier/f:type/f:coding/f:userSelected">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
